...
if __name__ == '__main__':
    ...
    print('=' * 40)
    success, failure = dcnm.put_interface_changes(interfaces_will_change)
    if failure:
        print()
        print()
        print('*' * 60)
    ...
    print('=' * 40)
    deploy_list: list
    deploy_list = DcnmInterfaces.create_deploy_list(success)
    if dcnm.deploy_interfaces(deploy_list):
        logger.debug('successfully deployed to {}'.format(success))
        print()
        print()
        print('*' * 60)
        ...
        logger.critical("Failed deploying to {}".format(success))
        print()
        print()
        print('*' * 60)
